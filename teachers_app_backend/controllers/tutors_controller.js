      ...
      .then((tutors) => {
        ...
        if (search) {
          filteredTutors = tutors.filter((tutor) => {
            return tutor.user.name.toLowerCase().includes(search.toLowerCase());
          });
        } else {
    ...
    if (alphabet != "false") {
      ...
      Teacher.find()
        ...
        .then((tutors) => {
          ...
          // Sort the filteredTutors array alphabetically based on the name of the user
